...
La universidad ABC está cambiando el sistema de calificación tradicional. Se propone que el alumno sea 
evaluado de manera constante. Para ello, al finalizar cada sesión de clase el profesor tomará una evaluación de 
los temas vistos en dicha sesión y de una duración máxima de quince minutos. Si el alumno falto a dicha sesión 
su nota para esa evaluación será de cero (0).
De acuerdo a ello se ha determinado que el alumno rendirá 13 pruebas que equivalen a las trece semanas de clase. 
...
b)	Desarrollar un subprograma que teniendo como base las 13 notas de un alumno, nos retorne el promedio final obtenido. 
El promedio final se calculará tomando las 10 mejores notas obtenidas durante las 13 sesiones que tiene el curso.
c)	Desarrollar un subprograma que determine reciba las notas promedio final de todos los alumnos y determine quién 
fue el mejor alumno de la clase. 
=end
